...
utterance = generate_language(automaton)
print("Generated Utterance:", utterance)
accept = recognize_language(automaton, 'baabaa')
print("baabaa", accept)
accept = recognize_language(automaton, 'baabbaa')
...
utterance = generate_language(automaton)
print("Generated Utterance:", utterance)
accept = recognize_language(automaton, 'abbaabbaabba')
print("abbaabbaabba", accept)
accept = recognize_language(automaton, 'baaab')
print("baaab", accept)
print("-----------------------------------------------")
...
utterance = generate_language(automaton)
print("Generated Utterance:", utterance)
accept = recognize_language(automaton, 'twenty five')
print("twenty five", accept)
accept = recognize_language(automaton, 'twelve one')
...
utterance = generate_language(model, 10)
print("Unigram Model")
print("Generated Utterance:", utterance)
prob = calculate_probability("<s> Sam I am </s>", model)
...
print("Probability:", prob)
print("-----------------------------------------------")
model = train_ngram(train_data, 3)
utterance = generate_language(model, 10)
print("Trigram Model")
print("Generated Utterance:", utterance)
prob = calculate_probability("<s> Sam I am </s>", model)
